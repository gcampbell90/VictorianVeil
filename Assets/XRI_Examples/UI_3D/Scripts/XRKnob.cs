...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRKnob : XRBaseInteractable
    {
        ...
        void EndGrab(SelectExitEventArgs args)
        {
            ...
            //StartCoroutine(ResetWheelPos());
        }

        private IEnumerator ResetWheelPos()
        {
            float dur = 2f;
            float t = 0f;
            ...
            {
                //Debug.Log(value);
                var rotVal = Mathf.Lerp(value, 0, t);
        ...
        void SetKnobRotation(float angle)
        {
            ...
            var newAngle = RoundToNearest22dot5Degrees(angle);

            if (m_Handle != null)
                m_Handle.localEulerAngles = new Vector3(0.0f, newAngle, 0.0f);
        }
