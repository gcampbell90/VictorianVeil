...
public class RadialPuzzleController : BasePuzzle
{
    ...
    //Member Methods
    private Node[] SetStaticRoute(NodeObject[] route)
    {
    ...
    private bool IsRouteOccupied(WaypointInteractable waypointInteractable)
    {
